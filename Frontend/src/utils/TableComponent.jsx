...
export default function TableComponent({ rows }) {
  ...
  return (
    <Box sx={{ width: "100%", overflowX: "auto", padding: isMobile ? 1 : 2 }}>
      <TableContainer component={Paper} elevation={3} sx={{ borderRadius: 3 }}>
        <Table sx={{ minWidth: 600 }} aria-label="HTTP Methods Table">
          <TableHead>
            ...
            {(rowsPerPage > 0
              ...
              <TableRow key={index} hover>
                ...
                <TableCell>
                  ...
                  <button
                    onClick={row.onClick}
                    className="bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-all duration-300 hover:bg-blue-700 hover:shadow-lg hover:scale-[1.03] focus:outline-none"
                  >
                    Call
                  </button>
                </TableCell>
